---
name: "source-command-continue-feature"
description: "Continue implementing the next task for a GitHub-published feature"
---

# source-command-continue-feature

Use this skill when the user asks to run the migrated source command `continue-feature`.
