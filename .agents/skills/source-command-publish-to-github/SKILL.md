---
name: "source-command-publish-to-github"
description: "Publish a feature from /specs to GitHub Issues and Projects"
---

# source-command-publish-to-github

Use this skill when the user asks to run the migrated source command `publish-to-github`.
